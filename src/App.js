...
const UnionMonitorDashboard = () => {
  ...
  // Enhanced News Functions with 120-minute caching
// Replace your existing fetchEnhancedUnionNews and fetchEnhancedMarketNews functions with these
...
const getCachedData = (key) => {
  try {
    ...
    // Check if cache is still valid (within 120 minutes)
...
// Enhanced union news fetcher with caching
export async function fetchEnhancedUnionNews() {
  ...
  // Enhanced search queries - same as before
...
// Enhanced market news fetcher with caching
...
// Update your main App.js fetchUnionNews function
...
// Update your main App.js fetchMarketNews function  
...
// Helper functions (include these in your App.js)
